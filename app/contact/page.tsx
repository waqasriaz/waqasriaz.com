    ...
    <>
      ...
      <main>
        ...
        <section className="relative pt-32 pb-20 bg-[#c4b5fd]/10 overflow-hidden">
          <div className="absolute w-96 h-96 bg-[#c4b5fd]/20 rounded-full -top-48 -right-48 blur-3xl" />
          <div className="absolute w-80 h-80 bg-[#c4b5fd]/20 rounded-full -bottom-40 -left-40 blur-3xl" />
