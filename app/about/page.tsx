...
export const metadata: Metadata = {
    ...
    description:
        'About Waqas Riaz - Software Developer and Product Builder. Creator of Houzez and Homey, with 14+ years of experience building digital products.',
};
        ...
        <>
            ...
            <main>
                ...
                <section className="relative pt-32 pb-20 bg-[#c4b5fd]/20 overflow-hidden">
                    ...
                    <div
                        className="hero-blob absolute w-80 h-80 bg-[#c4b5fd]/30 rounded-full -bottom-40 -right-40 blur-3xl"
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-8 lg:gap-24 items-center">
                            ...
                            <div className="text-center lg:text-left">
                                ...
                                <p className="hero-animate hero-animate-4 text-lg text-slate-600 leading-relaxed mb-8">
                                    Building digital products that help
                                    businesses grow. Creator of Houzez and
                                    Homey, powering 60,000+ websites worldwide.
                                </p>
                    ...
                    <div className="max-w-6xl mx-auto px-6">
                        ...
                        <div className="text-center max-w-2xl mx-auto mb-16">
                            ...
                            <p className="text-lg text-slate-600">
                                Software products used by thousands of
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div className="group bg-white rounded-2xl shadow-lg border border-slate-200 p-8 hover:shadow-xl hover:-translate-y-1 transition-all">
                                ...
                                <p className="text-slate-600 leading-relaxed mb-6">
                                    The #1 real estate WordPress theme with
                                    54,000+ sales. Complete property management,
                                    advanced search, and CRM features.
                                </p>
                                <a
                            ...
                            <div className="group bg-white rounded-2xl shadow-lg border border-slate-200 p-8 hover:shadow-xl hover:-translate-y-1 transition-all">
                                ...
                                <p className="text-slate-600 leading-relaxed mb-6">
                                    Premium vacation rental theme for
                                    Airbnb-style websites. Booking system,
                                    availability calendar, and marketplace
                                    features.
                                </p>
                                <a
                            ...
                            <div className="group bg-white rounded-2xl shadow-lg border border-slate-200 p-8 hover:shadow-xl hover:-translate-y-1 transition-all">
                                ...
                                <p className="text-slate-600 leading-relaxed mb-6">
                                    Native mobile app companion for Houzez.
                                    Property search, agent dashboard, and push
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-8 hover:shadow-xl hover:-translate-y-1 transition-all">
                                ...
                                <p className="text-slate-600 leading-relaxed">
                                    ...
                                    MySQL, REST APIs, Git, and modern
                            ...
                            <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-8 hover:shadow-xl hover:-translate-y-1 transition-all">
                                ...
                                <p className="text-slate-600 leading-relaxed">
                                    ...
                                    Flutter, app store deployment and
                                    optimization.
                                </p>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-8 hover:shadow-xl hover:-translate-y-1 transition-all">
                                ...
                                <p className="text-slate-600 leading-relaxed">
                                    Product strategy, UX design, market
                                    research, and building software that scales
                    ...
                    <div className="max-w-3xl mx-auto px-6">
                        ...
                        <div className="space-y-10">
                            <div>
                                ...
                                <p className="text-lg text-slate-600 leading-relaxed">
                                    I focus on building things right rather than
                                    fast. Every project gets the attention it
                                    deserves.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-lg text-slate-600 leading-relaxed">
                                    Regular updates, honest timelines, and
                            ...
                            <div>
                                ...
                                <p className="text-lg text-slate-600 leading-relaxed">
                                    I build software that scales and is
                                    maintainable over time, not just quick
                                    fixes.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-lg text-slate-600 leading-relaxed">
                                    The goal is always to help your business
                                    succeed, not just deliver code.
                                </p>
                            </div>
                        </div>
                    </div>
